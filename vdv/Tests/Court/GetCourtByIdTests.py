...
class GetCourtByIdTests(BaseCourtTestCase):

    # setUp & tearDown

    @classmethod
    def setUpClass(cls):
        super(GetCourtByIdTests, cls).setUpClass()

        operation_id = 'getCourtById'
    ...
    def tearDownClass(cls):
        ...
        super(GetCourtByIdTests, cls).tearDownClass()

    # Tests

    def test_get_court_given_valid_court_id_param(self):
        # Given
        ...
        self.check_dict1_in_dict2(self.valid_court_params, resp.json)

    def test_get_court_given_non_existing_court_id_param(self):
        # Given
        request_uri_path_with_param = create_request_uri_path_with_param(
            self.base_request_uri_path,
